...
MAIN_MENU DB ,0DH,0AH,"CALCULATOR",0DH,0AH
          DB "SELECT '+' For ADDITION",0DH,0AH
          DB "SELECT '-' For SUBTRACTION",0DH,0AH
          DB "SELECT '*' For MULTIPLICATION",0DH,0AH
          DB "SELECT '/' For DIVISION",0DH,0AH
          DB "SELECT 'E' For EXIT",0DH,0AH
          DB "SELECT 'R' For RETURN to Main Menu",0DH,0AH
...
EX DB ,0DH,0AH,"GOOD BYE AND HAVE A NICE TIME :)",0DH,0AH,'$'  
       ...
       CONTINUE DB ,0DH,0AH,"DO YOU WANT TO CONTINUE SELECT CAPITAL( Y or N)",0DH,0AH,'$'       
          OP1 DB ?
          OP2 DB ?
          Operand DB ?
          CON DB ?
